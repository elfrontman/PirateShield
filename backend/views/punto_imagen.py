...
from backend.models import ImageProduct, DetailImageProduct
...
def image_detail(request, pk, pk_image_product, pk_product):
...
def delete_detail(request, pk, pk_image_product, pk_product):
